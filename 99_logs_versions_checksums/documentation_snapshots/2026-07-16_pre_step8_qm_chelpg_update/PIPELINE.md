...
|---|---|---|
| compound_08 | GFN2-xTB pre-optimization followed by HF/6-31G* single point | HOMO-LUMO gap is descriptor only; do not compare directly with 09/11 |
| compound_09 | omegaB97X-D3/def2-SVP/CPCM(water) | comparable with compound_11 |
| compound_11 | omegaB97X-D3/def2-SVP/CPCM(water) | comparable with compound_09 |
